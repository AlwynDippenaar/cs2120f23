...
- Give English explanations of these function types
    #1 takes in a function (which takes in a string and outputs a string) and outputs a string.
    #2 and #3 takes in two strings and outputs a string.
- Give some examples of functions of these types
    #1 is like String.strip String.upper " hello " [IDK the method names in Lean]
    #2 and #3 are like String.append
-/
