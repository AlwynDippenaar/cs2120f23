...
#eval eval_expr e4 (λ _ => false) -- expect true
#eval eval_expr e4 (λ _ => true)  -- expect true
...
def my_interpretation : var → Bool :=
fun v => match v.n with
| 0 => false
| 1 => true
| 2 => true
| 3 => false
...
#eval eval_expr e0 my_interpretation  -- expect true
#eval eval_expr e1 my_interpretation  -- expect true
#eval eval_expr e2 my_interpretation  -- expect true
#eval eval_expr e3 my_interpretation  -- expect true
#eval eval_expr e4 my_interpretation  -- expect true
